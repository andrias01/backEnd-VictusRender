...
//
//    @GetMapping("/dummy")
//    public StateDAO getDummy() {
//        return StateDAO.create();
//    }
//
//    @PostMapping("/create")
//    public ResponseEntity<GenericResponse> create(@RequestBody StateDAO country) {
//        var messages = new ArrayList<String>();
//        
//        try {
//        	var registerNewStateFacade = new RegisterNewCountryFacadeImpl();
//            registerNewStateFacade.execute(country);
//
...
//
//    @PutMapping("/{id}")
//    public ResponseEntity<CountryResponse> update(@PathVariable UUID id, @RequestBody StateDAO country) {
